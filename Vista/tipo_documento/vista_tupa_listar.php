<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Mantenimiento TUPA</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="index.php" ><i class="fa fa-home"></i> Inicio</a></li>
          <li class="breadcrumb-item active">TUPA</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Listado de TUPA</h3>
          ...
          <div class="card-body">
            <table id="tabla_tupa"  class="table tabel-display table-nowrap">
              <thead>
                <tr>
                  <th>#</th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><b>REGISTRAR TUPA</b></h5>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success btn-sm" onclick="Registrar_TUPA()">Guardar</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="modal_editar" data-backdrop="static" data-keyboard="false" tabindex="-1″ id="MiModal" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><b>MODIFICAR TUPA</b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="row">
          <div class="col-sm-6">
            <input type="text" id="tupa_id" hidden>                      <!-- text input -->
            <div class="form-group">
              <label>Nombre</label>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success btn-sm" data-dismiss="modal" style="background:white;color:#28a745">Cerrar</button>
        <button type="button" class="btn btn-success btn-sm" onclick="Modificar_TUPA()">Modificar</button>
      </div>
    </div>
  </div>
</div>
<!-- Fin Modal -->
<script src="js/console_tupa.js?rev=<?php echo time();?>"></script>

<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Mantenimiento tipo de documento</h1>
      </div>
      <div class="col-sm-6">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Listado de tipo de documento</h3>
          ...
          <div class="card-body">
            <table id="tabla_tipodocumento"  class="table tabel-display table-nowrap">
              <thead>
                <tr>
                  <th>#</th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><b>REGISTRAR TIPO DOCUMENTO</b></h5>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success btn-sm" onclick="Registrar_TipoDocumento()">Guardar</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="modal_editar" data-backdrop="static" data-keyboard="false" tabindex="-1″ id="MiModal" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="row">
          <div class="col-sm-6">
            <input type="text" id="idtipodocumento" hidden>                      <!-- text input -->
            <div class="form-group">
              <label>Nombre</label>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success btn-sm" data-dismiss="modal" style="background:white;color:#28a745">Cerrar</button>
        <button type="button" class="btn btn-success btn-sm" onclick="Modificar_TipoDocumento()">Modificar</button>
      </div>
    </div>
  </div>
</div>

...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Mantenimiento Tr&aacute;mite Recibidos</h1>
      </div>
      <div class="col-sm-6">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Listado de los Tr&aacute;mites Recibidos</h3>
          ...
          <div class="card-body" style="color:#000000;font-size:small;">
            ...
            <div class="col-12" style="text-align: right;">
              ...
              <label>0 - 1 d&iacute;as Negro &nbsp;&nbsp;|&nbsp;&nbsp; </label>
              <label style="color: green;">2 d&iacute;as Verde &nbsp;&nbsp;|&nbsp;&nbsp;</label>
              <label style="color: #ff7e00;">3 d&iacute;as &Aacute;mbar &nbsp;&nbsp;|&nbsp;&nbsp;</label>
              <label style="color: red;">4 d&iacute;as a m&aacute;s Rojo</label>
            </div>

...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Mantenimiento Tr&aacute;mites Enviados</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="index.php" ><i class="fa fa-home"></i> Inicio</a></li>
          <li class="breadcrumb-item active"> Tr&aacute;mites enviados</li>
        </ol>
      </div>
    </div>
  </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Listado de los Tr&aacute;mites enviados</h3>
              ...
              <table id="tabla_documento" style="table-layout:fixed;width: 100%" class="table tabel-display table-nowrap">
                <thead>
                  <tr>
                    ...
                    <th style="text-align: center;width: 50px;word-wrap: break-word;">Seguimiento</th>
